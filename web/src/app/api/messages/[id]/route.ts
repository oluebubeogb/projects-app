...
type MessageKind = "text" | "voice" | "system" | "image" | "file";
...
export async function POST(req: NextRequest, ctx: Ctx) {
  ...
  const allowed: MessageKind[] = ["text", "voice", "system", "image", "file"];
  const kind: MessageKind = allowed.includes(body.kind as MessageKind)
    ? (body.kind as MessageKind)
    : "text";

  if (!text && !body.mediaPath && kind === "text") {
